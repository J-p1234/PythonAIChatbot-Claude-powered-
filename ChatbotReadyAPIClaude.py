...
SYSTEM_PROMPT = "You are a friendly and helpful assistant, you should not answer yes all the time."
...
class ChatbotUI:
    def __init__(self, root):
        ...
        # Title
        tk.Label(
            root, text="Claude", font=("Helvetica", 16, "bold"),
            fg="#FFFFFF", bg="#2E2E2E"
        ).pack(pady=10)

        # Chat area (scrollable)
        self.chat_area = scrolledtext.ScrolledText(
            root, wrap=tk.WORD, height=40, width=60, font=("Arial", 11),
            bg="#3C3C3C", fg="#E0E0E0", insertbackground="white"
        )
        self.chat_area.pack(pady=10, padx=10)
        self.chat_area.insert(tk.END,
                              "Welcome to the Claude!\n"
    ...
    def clear_chat(self):
        ...
        self.chat_area.insert(tk.END, "Welcome! Ask me anything.\n")
        self.chat_area.config(state='disabled')
